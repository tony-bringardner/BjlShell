...
public class FileSourceShPreProcessorBraceLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DIGIT", "LETTER_OR_DIGIT", "LCURLY", "RCURLY", "DOT_DOT", "TEXT", "LETTER", 
			"WS"
		};
	}
	...
	public FileSourceShPreProcessorBraceLexer(CharStream input) {
		super(input);
