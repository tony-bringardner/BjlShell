...
public class TreeViewer extends JComponent {
	...
	public TreeViewer(List<String> ruleNames,Vocabulary vocabulary, Tree tree) {
		this.ruleNames= ruleNames;
	...
	protected String getText(Tree tree) {
		...
		if( showPosition) {
			if (tree instanceof ParserRuleContext) {
				...
				if( sym !=null) {
					s+="("+sym.getLine()+","+sym.getCharPositionInLine()+")";
				}
			} else {
				throw new RuntimeException("No line info for "+tree.getClass());
			}
		}
